            ...
            <Card.Group centered itemsPerRow={2}>
              {artist.map(unit => (
                <Card key={unit.id} color="teal" size="small">
                  ...
                  <Image src={unit.images[1].url} size="mini" />
                  <Card.Content>
                    <Card.Header>{unit.name}</Card.Header>
                  </Card.Content>
                </Card>
          ...
          <Grid.Column>
            ...
            <Card.Group centered itemsPerRow={2}>
              {playlist.map(playlist => (
                <Card key={playlist.id} color="olive" size="mini">
                  <Image 
                  src={playlist.images[0].url} size="mini" alt='no image'/>
                  <Card.Content>
